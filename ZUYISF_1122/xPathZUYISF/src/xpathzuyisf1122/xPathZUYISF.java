...
public class xPathZUYISF
{
    ...
    public static void main(String[] args) {
        try {
            ...
            /*Oktató módosítása*/
            modifyElementValue(doc, "1", "oktato", "Kiss Klára");

            /*Helyszín módosítása*/
            modifyElementValue(doc, "3", "helyszin", "XXXII A1 magasfsz");

            /*Tárgy módosítása*/
            modifyElementValue(doc, "5", "targy", "Matematika");
            ...
            StreamResult result = new StreamResult(new File("orarendZUYISF1.xml"));
